...
try {
    ...
    themeColorToggle && themeColorToggle.addEventListener("click", function (e) {
        ...
        if (currentTheme === "light") {
            // Eðer þu an light mod ise dark moda geç
            document.documentElement.setAttribute("data-bs-theme", "dark");
            // Dark moda geçince toggle düðmesinde kullanýcýya "light mod" seçeneðini göstermek için sun simgesini gizle, moon simgesini göster
            themeColorToggle.querySelector(".light-mode").style.display = "none";
            themeColorToggle.querySelector(".dark-mode").style.display = "block";
        } else {
            // Aksi halde (dark modda) light moda geç
            document.documentElement.setAttribute("data-bs-theme", "light");
            // Light moda geçince toggle düðmesinde kullanýcýya "dark mod" seçeneðini göstermek için sun simgesini göster, moon simgesini gizle
            themeColorToggle.querySelector(".light-mode").style.display = "block";
            themeColorToggle.querySelector(".dark-mode").style.display = "none";
        }
    });
} catch (e) {
    console.error(e);
